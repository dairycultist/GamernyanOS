...
**Boot sector** - The very beginning of the OS image, and the part of memory the computer reads first to set up functionality. Contains the **bootloader**, machine code that sets up the stack and calls the C main function of the **kernel**.
